...
@InputType()
class PlaylistUpdateManyWithoutSpotifyAccountsInput {
...
export { PlaylistUpdateManyWithoutSpotifyAccountsInput as PlaylistUpdateManyWithoutSpotifyAccountsInput };
